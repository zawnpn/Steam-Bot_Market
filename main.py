...
if __name__ == '__main__':
    ...
    parser.add_argument('--itemnum', type=int, default=0, help='Amount of items')
    ...
    parser.add_argument('--counts', type=int, default=5, help='Transactions counts')
    ...
    final_result = price_compare(args.game, gameParam, sleeptime=args.sleep, itemlen=args.itemnum, 
                                 threshold=args.thresh, counts=args.counts, savefile=args.save, outprint=args.print)
    if args.mail:
